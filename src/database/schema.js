...
const MIGRATIONS = [
    ...
    },
    {
        version: 5,
        statements: [
            `CREATE TABLE IF NOT EXISTS event_code_lookup (
                event_code INT NOT NULL,
                event_category VARCHAR(64) NOT NULL,
                description VARCHAR(255) NOT NULL,
                PRIMARY KEY (event_code)
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci`,
            `INSERT INTO event_code_lookup (event_code, event_category, description) VALUES
                (1, 'Voltage related', 'R-phase - VT link missing (missing potential) - occurrence'),
                (2, 'Voltage related', 'R-phase - VT link missing (missing potential) - restoration'),
                (3, 'Voltage related', 'Y-phase - VT link missing (missing potential) - occurrence'),
                (4, 'Voltage related', 'Y-phase - VT link missing (missing potential) - restoration'),
                (5, 'Voltage related', 'B-phase - VT link missing (missing potential) - occurrence'),
                (6, 'Voltage related', 'B-phase - VT link missing (missing potential) - restoration'),
                (7, 'Voltage related', 'Over voltage in any phase - occurrence'),
                (8, 'Voltage related', 'Over voltage in any phase - restoration'),
                (9, 'Voltage related', 'Low voltage in any phase - occurrence'),
                (10, 'Voltage related', 'Low voltage in any phase - restoration'),
                (11, 'Voltage related', 'Voltage unbalance - occurrence'),
                (12, 'Voltage related', 'Voltage unbalance - restoration'),
                (51, 'Current related', 'R-phase CT reverse - occurrence'),
                (52, 'Current related', 'R-phase CT reverse - restoration'),
                (53, 'Current related', 'Y-phase CT reverse - occurrence'),
                (54, 'Current related', 'Y-phase CT reverse - restoration'),
                (55, 'Current related', 'B-phase CT reverse - occurrence'),
                (56, 'Current related', 'B-phase CT reverse - restoration'),
                (57, 'Current related', 'R-phase CT open - occurrence'),
                (58, 'Current related', 'R-phase CT open - restoration'),
                (59, 'Current related', 'Y-phase CT open - occurrence'),
                (60, 'Current related', 'Y-phase CT open - restoration'),
                (61, 'Current related', 'B-phase CT open - occurrence'),
                (62, 'Current related', 'B-phase CT open - restoration'),
                (63, 'Current related', 'Current unbalance - occurrence'),
                (64, 'Current related', 'Current unbalance - restoration'),
                (65, 'Current related', 'CT bypass - occurrence'),
                (66, 'Current related', 'CT bypass - restoration'),
                (67, 'Current related', 'Over current in any phase - occurrence'),
                (68, 'Current related', 'Over current in any phase - restoration'),
                (101, 'Power failure related', 'Power failure (3 phase) - occurrence'),
                (102, 'Power failure related', 'Power failure (3 phase) - restoration'),
                (151, 'Transaction related', 'Real time clock, date and time'),
                (152, 'Transaction related', 'Demand integration period'),
                (153, 'Transaction related', 'Profile capture period'),
                (154, 'Transaction related', 'Single-action schedule for billing dates'),
                (155, 'Transaction related', 'Activity calendar for time zones, etc.'),
                (201, 'Other events', 'Influence of permanent magnet or AC/DC electromagnet - occurrence'),
                (202, 'Other events', 'Influence of permanent magnet or AC/DC electromagnet - restoration'),
                (203, 'Other events', 'Neutral disturbance - HF and DC - occurrence'),
                (204, 'Other events', 'Neutral disturbance - HF and DC - restoration'),
                (205, 'Other events', 'Very low power factor - occurrence'),
                (206, 'Other events', 'Very low power factor - restoration'),
                (251, 'Non-rollover events', 'Meter cover opening - occurrence'),
                (301, 'Control events', 'Meter load disconnected'),
                (302, 'Control events', 'Meter load connected')
